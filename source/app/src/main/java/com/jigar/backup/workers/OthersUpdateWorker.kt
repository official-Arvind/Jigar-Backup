package com.jigar.backup.workers
...
import com.jigar.backup.database.entity.FieldMap
import com.jigar.backup.database.entity.MutableFieldMap
...
import com.jigar.backup.util.NotificationHelper.NOTIFICATION_ID_OTHERS_UPDATE_WORKER
