 ...
 */
package com.jigar.backup.ui.theme.color.palettes
 ...
 * @deprecated Use [com.jigar.backup.ui.theme.color.dynamiccolor.DynamicScheme] for color scheme
...
class CorePalette private constructor(argb: Int, isContent: Boolean) {
    ...
    companion object {
         ...
         * @deprecated Use [com.jigar.backup.ui.theme.color.dynamiccolor.DynamicScheme] for color
