...
Java_com_jigar_libnative_NativeLib_calculateSize(JNIEnv *env, jobject, jstring path) {
...
Java_com_jigar_libnative_NativeLib_getUidGid(JNIEnv *env, jobject, jstring path) {
