...
import com.jigar.core.datastore.readCompressionTest
import com.jigar.core.model.BlacklistAppItem
import com.jigar.core.model.BlacklistFileItem
import com.jigar.core.model.CompressionType
import com.jigar.core.model.Configurations
import com.jigar.core.model.ConfigurationsBlacklist
import com.jigar.core.model.FileItem
...
class CommonBackupUtil @Inject constructor(
    ...
    fun getItselfDst(dstDir: String) = "${dstDir}/Jigar Backup.apk"
