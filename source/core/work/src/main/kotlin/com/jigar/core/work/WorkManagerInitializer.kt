package com.jigar.core.work

import android.content.Context
import androidx.work.ExistingWorkPolicy
import androidx.work.WorkManager
import com.jigar.core.data.repository.FAST_INIT_AND_UPDATE_APPS_WORK_NAME
import com.jigar.core.data.repository.FAST_INIT_AND_UPDATE_FILES_WORK_NAME
import com.jigar.core.data.repository.FULL_INIT_AND_UPDATE_APPS_WORK_NAME
import com.jigar.core.data.repository.FULL_INIT_WORK_NAME
import com.jigar.core.data.repository.LOAD_APP_BACKUPS_WORK_NAME
import com.jigar.core.data.repository.LOAD_FILE_BACKUPS_WORK_NAME
import com.jigar.core.work.workers.AppsFastInitWorker
import com.jigar.core.work.workers.AppsFastUpdateWorker
import com.jigar.core.work.workers.AppsInitWorker
import com.jigar.core.work.workers.AppsLoadWorker
import com.jigar.core.work.workers.AppsUpdateWorker
import com.jigar.core.work.workers.FilesLoadWorker
import com.jigar.core.work.workers.FilesUpdateWorker
