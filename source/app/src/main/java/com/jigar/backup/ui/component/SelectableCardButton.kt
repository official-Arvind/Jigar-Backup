...
import com.jigar.backup.ui.theme.tone
...
fun selectableCardButtonGreenColors(
    selectedCircleColor: Color = JigarBackupTheme.greenColorScheme.primary,
    selectedIconColor: Color = JigarBackupTheme.greenColorScheme.onPrimary,
    selectedIconButtonColor: Color = JigarBackupTheme.greenColorScheme.primary,
    selectedTitleColor: Color = JigarBackupTheme.greenColorScheme.primary,
    selectedBorderColor: Color = JigarBackupTheme.greenColorScheme.primary,
    selectedBackgroundColor: Color = JigarBackupTheme.greenColorScheme.surfaceContainer.tone(if (isSystemInDarkTheme()) 12 else 98),
) = selectableCardButtonPrimaryColors(
    selectedCircleColor = selectedCircleColor,
    selectedIconColor = selectedIconColor,
    selectedIconButtonColor = selectedIconButtonColor,
