...
package com.jigar.core.ui.theme
...
import com.jigar.core.ui.material3.TonalPalette
import com.jigar.core.ui.material3.tokens.PaletteTokens
...
fun dynamicLightThemedColorScheme(context: Context): ThemedColorScheme {
    return if (Build.VERSION.SDK_INT >= 34) {
        // SDKs 34 and greater return appropriate Chroma6 values for neutral palette
        dynamicLightThemedColorScheme34(context)
    } else {
        ...
        dynamicLightThemedColorScheme31(tonalPalette)
    }
}
 ...
 */
@RequiresApi(Build.VERSION_CODES.S)
fun dynamicDarkThemedColorScheme(context: Context): ThemedColorScheme {
    return if (Build.VERSION.SDK_INT >= 34) {
        // SDKs 34 and greater return appropriate Chroma6 values for neutral palette
        dynamicDarkThemedColorScheme34(context)
    } else {
        // SDKs 31-33 return Chroma4 values for neutral palette, we instead leverage neutral
        // variant which provides chroma8 for less grey tones.
        val tonalPalette = dynamicTonalPalette(context)
        dynamicDarkThemedColorScheme31(tonalPalette)
    }
}
...
@RequiresApi(31)
internal fun dynamicLightThemedColorScheme31(tonalPalette: TonalPalette) = lightThemedColorScheme(
    ...
    surfaceVariantDim = tonalPalette.neutral95,
    primaryL80D20 = tonalPalette.primary80,
    secondaryL80D20 = tonalPalette.secondary80,
    tertiaryL80D20 = tonalPalette.tertiary80,
    errorL80D20 = tonalPalette.error80,
)

@RequiresApi(34)
internal fun dynamicLightThemedColorScheme34(context: Context) = lightThemedColorScheme(
...
@RequiresApi(31)
internal fun dynamicDarkThemedColorScheme31(tonalPalette: TonalPalette) = darkThemedColorScheme(
    ...
    surfaceVariantDim = tonalPalette.neutral20,
    primaryL80D20 = tonalPalette.primary20,
    secondaryL80D20 = tonalPalette.secondary20,
    tertiaryL80D20 = tonalPalette.tertiary20,
    errorL80D20 = tonalPalette.error20,
)

@RequiresApi(34)
internal fun dynamicDarkThemedColorScheme34(context: Context) = darkThemedColorScheme(
