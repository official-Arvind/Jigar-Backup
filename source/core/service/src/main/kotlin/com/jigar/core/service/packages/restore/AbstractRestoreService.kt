...
import com.jigar.core.datastore.readKillAppOption
import com.jigar.core.datastore.readResetRestoreList
import com.jigar.core.datastore.readRestorePermissions
import com.jigar.core.datastore.readRestoreSsaid
import com.jigar.core.datastore.readRestoreUser
import com.jigar.core.datastore.saveLastRestoreTime
import com.jigar.core.model.DataType
import com.jigar.core.model.OpType
import com.jigar.core.model.OperationState
import com.jigar.core.model.ProcessingInfoType
import com.jigar.core.model.ProcessingType
import com.jigar.core.model.TaskType
import com.jigar.core.model.database.Info
...
import com.jigar.core.service.R
import com.jigar.core.service.packages.AbstractPackagesService
import com.jigar.core.service.util.PackagesRestoreUtil
import com.jigar.core.util.DateUtil
import com.jigar.core.util.NotificationUtil
        ...
        packages.forEach { pkg ->
            mPkgEntities.add(
                TaskDetailPackageEntity(
                    taskId = mTaskEntity.id,
                    packageEntity = pkg,
                    apkInfo = Info(title = mContext.getString(com.jigar.core.data.R.string.args_restore, DataType.PACKAGE_APK.type.uppercase())),
                    userInfo = Info(title = mContext.getString(com.jigar.core.data.R.string.args_restore, DataType.PACKAGE_USER.type.uppercase())),
                    userDeInfo = Info(title = mContext.getString(com.jigar.core.data.R.string.args_restore, DataType.PACKAGE_USER_DE.type.uppercase())),
                    dataInfo = Info(title = mContext.getString(com.jigar.core.data.R.string.args_restore, DataType.PACKAGE_DATA.type.uppercase())),
                    obbInfo = Info(title = mContext.getString(com.jigar.core.data.R.string.args_restore, DataType.PACKAGE_OBB.type.uppercase())),
                    mediaInfo = Info(title = mContext.getString(com.jigar.core.data.R.string.args_restore, DataType.PACKAGE_MEDIA.type.uppercase())),
                ).apply {
                    id = mTaskDao.upsert(this)
                }
            )
