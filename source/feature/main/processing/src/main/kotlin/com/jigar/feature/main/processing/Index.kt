...
import com.jigar.core.datastore.saveScreenOffCountDown
import com.jigar.core.model.OperationState
import com.jigar.core.ui.component.AnimatedTextContainer
import com.jigar.core.ui.component.BodyLargeText
import com.jigar.core.ui.component.HeadlineMediumText
import com.jigar.core.ui.component.LocalSlotScope
import com.jigar.core.ui.component.PackageIconImage
import com.jigar.core.ui.component.ProcessingCard
import com.jigar.core.ui.component.SegmentCircularProgressIndicator
import com.jigar.core.ui.component.Surface
...
import com.jigar.core.ui.component.paddingTop
import com.jigar.core.ui.component.paddingVertical
    ...
    ProcessingSetupScaffold(
        ...
        Column(
            ...
            Column(
                ...
                val animatedImageVector = AnimatedImageVector.animatedVectorResource(com.jigar.core.ui.R.drawable.ic_animated_tick)
                        ...
                        if (it != null) {
                            ...
                            when (it) {
                                dataItems.size + 2 -> {
                                    ...
                                    PackageIconImage(
                                        icon = if (it > 0 && it < dataItems.size + 1) null else ImageVector.vectorResource(id = com.jigar.core.ui.R.drawable.ic_rounded_hourglass_empty),
