...
import androidx.compose.ui.unit.dp
import com.jigar.core.ui.token.DialogTokens
                    ...
                    ProvideTextStyle(textStyle) {
                        Box(
                            Modifier
                                ...
                                .padding(if (textHorizontalPadding) TextPadding else ContentPadding)
...
private val TextPadding = PaddingValues(start = 24.dp, end = 24.dp, bottom = 24.dp)
private val ContentPadding = PaddingValues(bottom = 24.dp)
private val ButtonPadding = PaddingValues(start = 24.dp, end = 24.dp)
