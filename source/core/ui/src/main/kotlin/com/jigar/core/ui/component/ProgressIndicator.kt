...
import com.jigar.core.ui.material3.LinearIndicatorHeight
import com.jigar.core.ui.material3.LinearIndicatorWidth
import com.jigar.core.ui.material3.drawLinearIndicator
import com.jigar.core.ui.material3.drawLinearIndicatorTrack
import com.jigar.core.ui.material3.util.fastForEach
import com.jigar.core.ui.model.MultiColorProgress
...
fun SegmentProgressIndicator(modifier: Modifier = Modifier, enabled: Boolean = false, progress: Float, color: ThemedColorSchemeKeyTokens, trackColor: ThemedColorSchemeKeyTokens) {
    Row(modifier = modifier, verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(SizeTokens.Level4)) {
        ...
        if (corrected > 0.05f)
            com.jigar.core.ui.component.LinearProgressIndicator(
