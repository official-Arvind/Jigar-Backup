...
fun PermissionCard(
    ...
    val animatedColor by animateColorAsState(
        targetValue = when (state) {
            ...
            is CardState.Success -> JigarBackupTheme.greenColorScheme.primaryContainer
    ...
    val animatedContentColor by animateColorAsState(
        targetValue = when (state) {
            is CardState.Success -> JigarBackupTheme.greenColorScheme.onPrimaryContainer
    ...
    val animatedSupportingColor by animateColorAsState(
        targetValue = when (state) {
            is CardState.Success -> JigarBackupTheme.greenColorScheme.onPrimaryContainer.copy(alpha = 0.75f)
