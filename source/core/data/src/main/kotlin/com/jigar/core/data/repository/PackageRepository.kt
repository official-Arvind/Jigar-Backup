...
import com.jigar.core.datastore.readCompressionType
import com.jigar.core.datastore.readReloadDumpApk
...
import com.jigar.core.model.util.suffixOf
...
class PackageRepository @Inject constructor(
     ...
     *        /.../Jigar Backup/backup/$userId/data/$packageName/$coverOrTimestamp/${dataType}.tar.*
     * --->   /.../Jigar Backup/apps/$packageName/user_$userId@$timestamp/${dataType}.tar.*
     */
    ...
    /**
     * Modify directory structure from local.
     *        /.../Jigar Backup/backup/$userId/media/$name/$coverOrTimestamp/${dataType}.tar.*
     * --->   /.../Jigar Backup/files/$name@$timestamp/${dataType}.tar.*
     */
    ...
    /**
     * Modify directory structure from local.
     *        /.../Jigar Backup/archives/packages/$packageName/$timestamp/${dataType}.tar.*
     * --->   /.../Jigar Backup/apps/$packageName/user_$userId@$timestamp/${dataType}.tar.*
     */
    ...
    /**
     * Modify directory structure from local.
     *        /.../Jigar Backup/archives/medium/$name/$timestamp/${dataType}.tar.*
     * --->   /.../Jigar Backup/files/$name@$timestamp/${dataType}.tar.*
     */
